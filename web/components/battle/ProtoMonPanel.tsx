...
export function ProtoMonPanel() {
  return (
    <section className="rounded-[28px] border border-white/10 bg-white/6 p-6">
      <p className="text-xs uppercase tracking-[0.28em] text-cyan-200/80">ProtoMon</p>
      <div className="mt-4 rounded-[24px] border border-white/10 bg-slate-950/55 p-5">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white">ProtoMon // Initiate</h2>
            <p className="mt-1 text-sm text-slate-400">
              未来会在这里接入被动道具、遗物和更完整的角色成长。
            </p>
          </div>
        </div>
      ...
      <div className="mt-4 rounded-[24px] border border-dashed border-white/12 bg-slate-950/40 p-4">
        <p className="text-xs uppercase tracking-[0.2em] text-slate-500">Passive Slot</p>
        <p className="mt-2 text-sm text-slate-300">
          Future relic / passive item area. Current build keeps this as a placeholder only.
        </p>
      </div>
    </section>
  );
